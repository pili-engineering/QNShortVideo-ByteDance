...
typedef NS_ENUM(NSUInteger, BEEffectPanelTabType) {
    BEEffectPanelTabFace,
    BEEffectPanelTabGesture,
    BEEffectPanelTabBody,
    BEEffectPanelTabBeauty,
    BEEffectPanelTabFilter,
    BEEffectPanelTabMakeup,
    BEEffectPanelTabSegmentation,
    BEEffectPanelTabFaceVerify,
    BEEffectPanelTabHumanDistance
};
...
@property (nonatomic, copy) NSArray<BEFaceBeautyModel *> *beautyModels;
