...
import com.qiniu.shortvideo.bytedance.view.FrameSelectorView;
import com.qiniu.shortvideo.bytedance.view.ObservableHorizontalScrollView;
...
import static com.qiniu.shortvideo.bytedance.activity.VideoFrameActivity.DATA_EXTRA_JUMP;
import static com.qiniu.shortvideo.bytedance.activity.VideoFrameActivity.DATA_EXTRA_PATHS;
import static com.qiniu.shortvideo.bytedance.activity.VideoFrameActivity.DIVIDE_REQUEST_CODE;
...
public class VideoDivideActivity extends Activity {
    ...
    private void jumpToActivity() {
        ...
        if (isJumpedTo) {
            setResult(DIVIDE_REQUEST_CODE, intent);
        } else {
